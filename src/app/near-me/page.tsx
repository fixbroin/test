...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title:
      'Carpenter, Plumber & Electrician Near Me in Bangalore',

    description:
      'Book trusted carpenter, plumber, electrician, TV installation, painting, and furniture assembly services near you in Bangalore with same-day service by FixBro experts.',
